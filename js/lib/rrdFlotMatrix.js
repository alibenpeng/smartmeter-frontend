...
rrdFlotMatrix.prototype.bindFlotGraph = function(flot_obj) {
  ...
  if (this.graph_options!=null) {
				if (this.graph_options.tooltipOpts != null) {graph_options.tooltipOpts = this.graph_options.tooltipOpts}
  ...
  if (this.graph_options!=null) {
    ...
    if (this.graph_options.bars!=null) {
      graph_options.bars=this.graph_options.bars;
    }
    if (this.graph_options.stack!=null) {
      graph_options.stack=this.graph_options.stack;
    }
  }
